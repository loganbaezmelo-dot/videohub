...
import { 
    ...
    GoogleAuthProvider, GithubAuthProvider, OAuthProvider, // <--- Added OAuthProvider for Yahoo
...
const firebaseConfig = {
  ...
  storageBucket: "video-website-64dab.firebasestorage.app", // Correct storage bucket
            ...
            <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg mx-4 my-8">
                ...
                <div className="mt-6">
                    ...
                    <div className="flex flex-col gap-3">
                        {/* GOOGLE BUTTON */}
                        <button onClick={() => onProviderLogin('google')} className="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none">
                        ...
                        {/* GITHUB BUTTON */}
                        <button onClick={() => onProviderLogin('github')} className="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-800 hover:bg-gray-900 focus:outline-none">
                        ...
                        {/* YAHOO BUTTON */}
                        <button onClick={() => onProviderLogin('yahoo')} className="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none">
...
const SettingsModal = ({ theme, onThemeChange, onCancel, sessions, onRevokeSession }) => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg w-full max-w-lg overflow-hidden shadow-2xl flex flex-col max-h-[80vh]">
                ...
                <div className="flex border-b border-gray-200 dark:border-gray-700">
                    ...
                    <button onClick={() => setActiveTab('security')} className={`flex-1 py-3 text-sm font-medium text-center ${activeTab === 'security' ? 'text-indigo-600 border-b-2 border-indigo-600 dark:text-indigo-400 dark:border-indigo-400' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'}`}>Security & Devices</button>
                </div>
...
function App() {
    ...
    return (
        <div className="bg-gray-100 dark:bg-gray-950 min-h-screen text-gray-900 dark:text-white font-sans">
            ...
            {isSettingsModalOpen && <SettingsModal theme={theme} onThemeChange={handleThemeChange} onCancel={() => setIsSettingsModalOpen(false)} sessions={sessions} onRevokeSession={handleRevokeSession} />}
