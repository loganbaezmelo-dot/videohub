            ...
            <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg mx-4 my-8">
                ...
                <div className="mt-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        {/* GOOGLE */}
                        <button onClick={() => onProviderLogin('google')} className="flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none">
                             <svg className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.276c0-.816-.069-1.604-.204-2.364H12v4.475h6.731c-.294 1.537-1.165 2.836-2.485 3.718v3.086h4.024c2.354-2.167 3.711-5.357 3.711-9.115z" /><path d="M12 24c3.24 0 5.956-1.074 7.943-2.906l-4.024-3.086c-1.075.721-2.451 1.146-3.919 1.146-3.127 0-5.773-2.113-6.721-4.952H1.255v3.114C3.212 21.087 7.325 24 12 24z" /><path d="M5.279 14.202c-.247-.737-.389-1.525-.389-2.336 0-.811.142-1.598.389-2.336V6.416H1.255C.454 8.014 0 9.952 0 12c0 2.048.454 3.985 1.255 5.584l4.024-3.114z" /><path d="M12 4.773c1.763 0 3.348.606 4.593 1.794l3.449-3.449C17.952 1.136 15.235 0 12 0 7.325 0 3.212 2.913 1.255 6.416l4.024 3.114c.948-2.84 3.594-4.953 6.721-4.953z" /></svg>
                             Google
                        </button>

                        {/* GITHUB */}
                        <button onClick={() => onProviderLogin('github')} className="flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-800 hover:bg-gray-900 focus:outline-none">
                        ...
                        {/* YAHOO */}
                        <button onClick={() => onProviderLogin('yahoo')} className="flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none">
                             <svg className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24"><path d="M2.25 2.25L12 16.5L21.75 2.25H18L12 11.25L6 2.25H2.25ZM10.5 18.75V21.75H13.5V18.75H10.5Z"/></svg>
                             Yahoo
                        </button>
                        
                        {/* TWITTER (Still here for future you!) */}
                        <button onClick={() => onProviderLogin('twitter')} className="flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-black hover:bg-gray-800 focus:outline-none">
                            <svg className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                            X (Twitter)
                        </button>
                    </div>
                </div>
...
// --- NEW SETTINGS MODAL with Account Linking ---
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg w-full max-w-lg overflow-hidden shadow-2xl flex flex-col max-h-[80vh]">
                        ...
                        <div className="space-y-4">
                             ...
                             <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <div className="flex items-center">
                                    <div className="bg-white p-1 rounded-full mr-3"><svg className="h-5 w-5" viewBox="0 0 24 24"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/><path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/></svg></div>
                             ...
                             <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <div className="flex items-center">
                                    <div className="bg-white p-1 rounded-full mr-3"><svg className="h-5 w-5" fill="black" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg></div>
                             ...
                             <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <div className="flex items-center">
                                    <div className="bg-white p-1 rounded-full mr-3"><svg className="h-5 w-5" fill="#6001D2" viewBox="0 0 24 24"><path d="M2.25 2.25L12 16.5L21.75 2.25H18L12 11.25L6 2.25H2.25ZM10.5 18.75V21.75H13.5V18.75H10.5Z"/></svg></div>
                    ...
                    {activeTab === 'security' && (
                        <div>
                            ...
                            <div className="space-y-3">
                                {sessions.length === 0 ? <p className="text-sm text-gray-500">No active sessions found.</p> : sessions.map(session => (
                                    <div key={session.id} className="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                        ...
                                        <button onClick={() => onRevokeSession(session.id)} className="text-sm text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300 font-medium">Remove</button>
                                    </div>
                                ))}
                            </div>
                        </div>
                ...
                <div className="p-6 border-t border-gray-200 dark:border-gray-700 flex justify-end"><button onClick={onCancel} className="px-6 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600">Done</button></div>
            </div>
        </div>
    );
};
...
function App() {
    ...
    useEffect(() => {
        ...
        const handleSystemChange = (e) => { if (localStorage.getItem('theme') === 'system') { document.documentElement.classList.toggle('dark', e.matches); } };
        applyTheme(theme);
    ...
    const registerSession = async (user) => {
        ...
        if (!sessionId) { sessionId = Math.random().toString(36).substring(2) + Date.now().toString(36); localStorage.setItem('sessionId', sessionId); }
        const sessionRef = doc(db, `/artifacts/${appId}/public/data/users/${user.uid}/sessions`, sessionId);
        await setDoc(sessionRef, { id: sessionId, deviceName: getDeviceName(), lastActive: serverTimestamp(), userAgent: navigator.userAgent });
    };
    ...
    const checkSessionValidity = async (user) => {
        ...
        if (!docSnap.exists()) { await signOut(auth); localStorage.removeItem('sessionId'); setView('landing'); showMessageHandler("Logged out from another device.", "error"); return false; }
        return true;
    };
    ...
    const handleRevokeSession = async (sessionId) => {
        ...
        try {
            await deleteDoc(doc(db, `/artifacts/${appId}/public/data/users/${currentUser.uid}/sessions`, sessionId));
            if (sessionId === localStorage.getItem('sessionId')) { await signOut(auth); localStorage.removeItem('sessionId'); setView('landing'); }
            showMessageHandler("Device removed.", "success");
        } catch (e) { console.error(e); showMessageHandler("Failed to remove device.", "error"); }
    };
    ...
    const handleLinkAccount = async (providerName) => {
        ...
        try {
            ...
            if (error.code === 'auth/credential-already-in-use') {
                // Conflict! Switch to the existing account
        ...
        const unsubscribeAuth = onAuthStateChanged(auth, async (user) => {
            if (user && !user.isAnonymous) {
                ...
                userProfileUnsubscribe = onSnapshot(userRef, async (doc) => {
                    if (doc.exists()) { setCurrentUserProfile(doc.data()); } 
                    else {
                ...
                const sessionsRef = collection(db, `/artifacts/${appId}/public/data/users/${user.uid}/sessions`);
                sessionsUnsubscribe = onSnapshot(sessionsRef, (snapshot) => { setSessions(snapshot.docs.map(d => ({id: d.id, ...d.data()}))); });
            } else if (user && user.isAnonymous) { setCurrentUser(user); setCurrentUserProfile(null); } 
            else { setCurrentUser(null); setCurrentUserProfile(null); setSessions([]); if (userProfileUnsubscribe) userProfileUnsubscribe(); if (sessionsUnsubscribe) sessionsUnsubscribe(); }
            setIsAuthReady(true);
        });
        const unsubVideos = onSnapshot(query(collection(db, `/artifacts/${appId}/public/data/videos`)), (s) => { setAllVideos(s.docs.map(d=>({id: d.id, ...d.data()})).sort((a,b)=>(b.createdAt?.toMillis()||0)-(a.createdAt?.toMillis()||0))); }, console.error);
        const unsubBytes = onSnapshot(query(collection(db, `/artifacts/${appId}/public/data/bytes`)), (s) => { setAllBytes(s.docs.map(d=>({id:d.id, ...d.data()})).sort((a,b)=>(b.createdAt?.toMillis()||0)-(a.createdAt?.toMillis()||0))); }, console.error);
        return () => { unsubscribeAuth(); unsubVideos(); unsubBytes(); if (userProfileUnsubscribe) userProfileUnsubscribe(); if (sessionsUnsubscribe) sessionsUnsubscribe(); };
    }, []); 
    ...
    const handleLogout = async () => { try { if (currentUser && localStorage.getItem('sessionId')) { await deleteDoc(doc(db, `/artifacts/${appId}/public/data/users/${currentUser.uid}/sessions`, localStorage.getItem('sessionId'))); } localStorage.removeItem('sessionId'); await signOut(auth); setView('landing'); showMessageHandler('Logged out.', 'success'); } catch (e) { showMessageHandler('Failed to log out.', 'error'); }};
    ...
    const handleUpload = async ({ videoFile, thumbnailFile, title, description, type, onProgress }) => {
        ...
        try { 
            ...
            // Smart Thumbnails: Only upload if file exists, otherwise use placeholder
            if (thumbnailFile) {
                thumbnailUrl = await uploadFile(thumbnailFile, `content/${currentUser.uid}/${timestamp}_${thumbnailFile.name}`, null);
            } else {
                thumbnailUrl = type === 'byte' ? `https://placehold.co/400x600/7c3aed/ffffff?text=${encodeURIComponent(title)}` : `https://placehold.co/600x400/4338ca/ffffff?text=${encodeURIComponent(title)}`;
            }
            await addDoc(collection(db, `/artifacts/${appId}/public/data/${type}s`), { title, description, videoUrl, thumbnailUrl, uploaderId: currentUser.uid, uploaderName: currentUserProfile.name || 'User', createdAt: serverTimestamp() }); 
    ...
    return (
        <div className="bg-gray-100 dark:bg-gray-950 min-h-screen text-gray-900 dark:text-white font-sans">
            ...
            {isSettingsModalOpen && <SettingsModal theme={theme} onThemeChange={handleThemeChange} onCancel={() => setIsSettingsModalOpen(false)} sessions={sessions} onRevokeSession={handleRevokeSession} currentUser={currentUser} onLinkAccount={handleLinkAccount} />}
