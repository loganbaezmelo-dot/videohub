...
// --- UPDATED AuthForm with BRAND LOGOS ---
                ...
                <div className="mt-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <button onClick={() => onProviderLogin('yahoo')} className="col-span-2 flex items-center justify-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-white bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none">
                             <img src="https://www.svgrepo.com/show/506626/yahoo.svg" alt="Yahoo" className="h-5 w-5 mr-2" />
                             Sign in with Yahoo
                        </button>
                    </div>
                </div>
                        ...
                        <div className="space-y-4">
                             ...
                             <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <div className="flex items-center">
                                    <div className="bg-white p-1 rounded-full mr-3"><img src="https://www.svgrepo.com/show/475656/google-color.svg" className="h-5 w-5" alt="Google" /></div>
                             ...
                             <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <div className="flex items-center">
                                    <div className="bg-white p-1 rounded-full mr-3"><img src="https://www.svgrepo.com/show/512317/github-142.svg" className="h-5 w-5" alt="GitHub" /></div>
                             ...
                             <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <div className="flex items-center">
                                    <div className="bg-white p-1 rounded-full mr-3"><img src="https://www.svgrepo.com/show/506626/yahoo.svg" className="h-5 w-5" alt="Yahoo" /></div>
