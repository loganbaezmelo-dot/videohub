...
// FIXED: Updated storageBucket to match your specific project address
const firebaseConfig = {
  ...
  storageBucket: "video-website-64dab.firebasestorage.app", // <--- THIS WAS THE FIX
...
const UploadForm = ({ onUpload, showMessage, defaultType }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        // Description is now fully optional
    ...
    return (
        <div className="max-w-2xl mx-auto p-6 sm:p-8 bg-white dark:bg-gray-800 rounded-lg mt-10 shadow-xl mb-20 sm:mb-0">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Conditionally render Thumbnail input ONLY for Videos */}
                {fileType === 'video' && (
                ...
                <button type="submit" disabled={isUploading} className="w-full py-2 px-4 text-white bg-indigo-600 rounded-md hover:bg-indigo-700 disabled:bg-gray-500 disabled:cursor-not-allowed">
